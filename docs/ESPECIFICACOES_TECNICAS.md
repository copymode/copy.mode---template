...
A versão atual do sistema é 2.0.7, com melhorias recentes focadas na experiência móvel, correção de problemas de UI, otimização de performance e ajuste do scroll da área de chat.
