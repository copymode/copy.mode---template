-- 20250510_create_chats_tables.sql
-- Script para criar as tabelas de chats e mensagens
...
-- Adiciona uma função para atualizar automatically a data de atualização das conversas
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT FROM pg_proc
