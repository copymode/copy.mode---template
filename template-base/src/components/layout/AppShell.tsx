...
import { Menu, X, Home, Users, Settings, ChevronRight, Moon, Sun, LogOut, ChevronsLeft, ChevronsRight, Trash2, Pencil, Plus, Bot, Search, UserCog, GraduationCap } from "lucide-react";
  ...
  return (
    <div className="grid md:grid-cols-[auto_1fr] min-h-screen bg-background h-screen">
             ...
             <nav>
               <ul className="space-y-1">
                 {[ 
                    ...
                    { path: "/how-to-use", icon: GraduationCap, label: "Como Usar" },
      ...
      <div className="flex flex-col h-screen overflow-hidden"> 
        <header 
          ref={headerRef} 
          className="bg-background border-b border-transparent sticky top-0 z-20 flex items-center justify-between h-16 px-4 md:px-6 flex-shrink-0"
        >
